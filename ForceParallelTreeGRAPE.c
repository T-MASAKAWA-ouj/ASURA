...
#if (defined(HAVE_GRAPE7) || defined(HAVE_GRAPE6A) || defined(HAVE_GRAPE5) || defined(HAVE_PHANTOM_GRAPE) || defined(HAVE_AVX_PHANTOM_GRAPE))
#include <gp5util.h>
#else
...
void InitializeRootForLET(void){
    ...
    LeavesExport = malloc(sizeof(struct StructGravityCache*)*NProcs);
    /* allocate communication buffer for export */
