...
static inline bool CheckDomainOverlapForActiveHydroEdges(double Pos[restrict], const double h, const int NodeID){
 ...
 * `true', otherwise the function returns `false'.
 */
static inline bool SinkStarBoundCheck(const double Mass_sink, const double Pos_sink[], const double Vel_sink[], const double Mass_star, const double Pos_star[], const double Vel_star[]) __attribute__((always_inline));
static inline bool SinkStarBoundCheck(const double Mass_sink, const double Pos_sink[], const double Vel_sink[],
...
static void CheckSinkFormationCondition(void){
    ...
    for(int i=0;i<Pall.Nhydro;i++){
        ...
        CalcSizeGetHydroInfo_i(counter-1,&PotentialMin,VCOM);

        double Ep = PhydroBody(i)->Pot;
 ...
 */
static inline int CheckSinkSinkExportFlagsForActiveEdges(const int Index, const int NProcs, bool SinkExportFlags[][NProcs-1], struct StructParticleDataForActiveSinkFOF ParticleDataForActiveFOF[restrict]) __attribute__((always_inline));
static inline int CheckSinkSinkExportFlagsForActiveEdges(const int Index, const int NProcs, bool SinkExportFlags[][NProcs-1], 
        struct StructParticleDataForActiveSinkFOF ParticleDataForActiveFOF[restrict]){
