 ...
 */
#ifndef __DEFINITION_H_INCLUDED__
#define __DEFINITION_H_INCLUDED__
...
struct StructPbody_tag{
    ...
    double    Vel[3];       // The velocity of the particle.
    double    Velh[3];      // <LEAN> The "half-step slided" velocity of the particle. For leapfrog integration.
...
#endif
#ifdef USE_CELIB
    double    Elements[CELibYield_Number]; //H, He, C, N, O, Ne, Mg, Si, S, Ca, Fe, Ni, Eu
#endif // USE_CELIB
...
struct StructPstar_tag{
    ...
    double  InitialMass;    // <LEAN> Initial Mass 
...
#ifdef USE_CELIB //{
    int       SNIaCount;        //
    double    EventTime;    // Next event time of SNII/Ia.
// #ifdef USE_CELIB_AGB //{
...
// #endif // USE_CELIB_AGB //}
    ...
    int       ECSNCount;         // Number of ECSN event.
    double    EventTimeECSN; // Next event timing of ECSN.
#endif // USE_CELIB_ECSN //}
#ifdef USE_CELIB_HN //{
    int       HNCount;         // Number of HN event.
    double    EventTimeHN; // Next event timing of HN.
#endif // USE_CELIB_HN //}
