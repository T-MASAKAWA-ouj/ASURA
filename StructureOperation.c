...
void ReConnectPointers(void){
    ...
    if(counter != Pall.Ntotal){
        ...
        MPI_Abort(ParticleDataArrayConsistencyError,MPI_COMM_WORLD);
...
void StructureReportPstar(const int Index){
    ...
    fprintf(stderr,"Pstar[%d]->EventTime = %.19g\n",Index,Pstar[Index]->EventTime);
#ifdef USE_CELIB_AGB //{
    ...
    fprintf(stderr,"Pstar[%d]->ECSNCount = %d\n",Index,Pstar[Index]->ECSNCount);
    fprintf(stderr,"Pstar[%d]->EventTimeECSN = %.19g\n",Index,Pstar[Index]->EventTimeECSN);
#endif // USE_CELIB_ECSN //}
#ifdef USE_CELIB_HN //{
    fprintf(stderr,"Pstar[%d]->HNCount = %d\n",Index,Pstar[Index]->HNCount);
    fprintf(stderr,"Pstar[%d]->EventTimeHN = %.19g\n",Index,Pstar[Index]->EventTimeHN);
#endif // USE_CELIB_HN //}
    ...
    fprintf(stderr,"Pstar[%d]->Element[Na] = %.19g\n",Index,Pstar[Index]->Elements[CELibYield_Na]);
    ...
    fprintf(stderr,"Pstar[%d]->Element[Zn] = %.19g\n",Index,Pstar[Index]->Elements[CELibYield_Zn]);
    fprintf(stderr,"Pstar[%d]->Element[Sr] = %.19g\n",Index,Pstar[Index]->Elements[CELibYield_Sr]);
    fprintf(stderr,"Pstar[%d]->Element[Eu] = %.19g\n",Index,Pstar[Index]->Elements[CELibYield_Eu]);
#endif // USE_CELIB //}
...
static void StructureReportPstarElement(StructPstarptr Ps){
    ...
    fprintf(stderr,"Ps->EventTime = %.19g\n",Ps->EventTime);
#ifdef USE_CELIB_AGB //{
...
#endif // USE_CELIB_NSM //}
#ifdef USE_CELIB_ECSN //{
    fprintf(stderr,"Ps->ECSNCount = %d\n",Ps->ECSNCount);
    fprintf(stderr,"Ps->EventTimeECSN = %.19g\n",Ps->EventTimeECSN);
#endif // USE_CELIB_ECSN //}
#ifdef USE_CELIB_HN //{
    fprintf(stderr,"Ps->HNCount = %d\n",Ps->HNCount);
    fprintf(stderr,"Ps->EventTimeHN = %.19g\n",Ps->EventTimeHN);
#endif // USE_CELIB_HN //}
    ...
    fprintf(stderr,"Ps->Element[Na] = %.19g\n",Ps->Elements[CELibYield_Na]);
    ...
    fprintf(stderr,"Ps->Element[Zn] = %.19g\n",Ps->Elements[CELibYield_Zn]);
    fprintf(stderr,"Ps->Element[Sr] = %.19g\n",Ps->Elements[CELibYield_Sr]);
    fprintf(stderr,"Ps->Element[Eu] = %.19g\n",Ps->Elements[CELibYield_Eu]);
#endif // USE_CELIB //}
